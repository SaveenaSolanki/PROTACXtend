...
| --- | --- | --- | --- | --- | --- |
| 1 | Target Resolver Agent | `executable_not_tested` | `P1_core_required` | `synglue_agent/agents/target_agent.py; synglue_agent/tools/protac_toolbox.py` | `TargetResolverAgent.run; ProtacDesignToolbox.resolve_target` |
| 2 | Binder Retrieval Agent | `local_demo_data_only` | `P1_core_required` | `synglue_agent/agents/binder_agent.py; synglue_agent/tools/protac_toolbox.py` | `TargetBinderRetrievalAgent.run; retrieve_known_binders; mine_external_binders` |
| 3 | Warhead Selection Agent | `heuristic_stub` | `P1_core_required` | `synglue_agent/agents/warhead_agent.py; synglue_agent/tools/warhead_selector.py` | `WarheadSelectionAgent.run; ProtacDesignToolbox.select_warheads` |
| 4 | Exit Vector Agent | `heuristic_stub` | `P1_core_required` | `synglue_agent/agents/exit_vector_agent.py; synglue_agent/tools/exit_vector_detector.py` | `ExitVectorDetectionAgent.run; detect_exit_vectors` |
| 5 | E3 Ligand Agent | `local_demo_data_only` | `P1_core_required` | `synglue_agent/agents/e3_agent.py; synglue_agent/tools/e3_selector.py` | `E3LigandSelectionAgent.run; select_e3_ligands` |
| 6 | Linker Generation Agent | `local_demo_data_only` | `P1_core_required` | `synglue_agent/agents/linker_agent.py; synglue_agent/tools/linker_generator.py` | `LinkerGenerationAgent.run; generate_state_of_the_art_linker_panel` |
| 7 | Construction / Assembly Agent | `executable_not_tested` | `P1_core_required` | `synglue_agent/agents/construction_agent.py; synglue_agent/tools/molecular_constructor.py` | `MolecularConstructionAgent.run; CandidateValidationAgent.run; construct_protac_candidates` |
| 8 | DC50 Prediction Agent | `heuristic_stub` | `P0_truthfulness_fix` | `synglue_agent/agents/prediction_agent.py; synglue_agent/tools/degradation_predictor.py` | `DegradationPredictionAgent.run; predict_degradation; predict_dc50_dmax` |
| 9 | Dmax Prediction Agent | `heuristic_stub` | `P0_truthfulness_fix` | `synglue_agent/agents/prediction_agent.py; synglue_agent/tools/degradation_predictor.py` | `DegradationPredictionAgent.run; predict_degradation; predict_dc50_dmax` |
| 10 | ADME/Tox Agent | `heuristic_stub` | `P0_truthfulness_fix` | `synglue_agent/agents/admet_agent.py; synglue_agent/tools/admet_predictors.py` | `ADMETAgent.run; predict_admet; run_rule_based_admet_flags` |
| 11 | Novelty/IP Agent | `local_demo_data_only` | `P0_truthfulness_fix` | `synglue_agent/agents/novelty_agent.py; synglue_agent/tools/novelty_checker.py` | `NoveltyAgent.run; check_novelty; search_pubchem_similarity_for_novelty` |
| 12 | Ternary Feasibility Agent | `heuristic_stub` | `P0_truthfulness_fix` | `synglue_agent/agents/ternary_agent.py; synglue_agent/tools/ternary_feasibility.py` | `TernaryFeasibilityAgent.run; assess_ternary_feasibility; run_optional_docking_stub` |
| 13 | Retrosynthesis Agent | `heuristic_stub` | `P0_truthfulness_fix` | `synglue_agent/tools/retrosynthesis_filter.py` | `retrosynthesis_feasibility_filter; explain_retrosynthesis_score` |
| 14 | Ranking Agent | `heuristic_stub` | `P0_truthfulness_fix` | `synglue_agent/agents/ranking_agent.py; synglue_agent/tools/ranker.py` | `RankingAgent.run; rank_candidates; pairwise_tournament_ranking` |
| 15 | Reflection/Evolution Agent | `heuristic_stub` | `P4_nice_to_have` | `synglue_agent/agents/reflection_agent.py; synglue_agent/agents/evolution_agent.py` | `ReflectionReviewAgent.run; EvolutionRefinementAgent.run; evolve_candidates` |
| 16 | Safety/Human Review Agent | `executable_not_tested` | `P0_truthfulness_fix` | `synglue_agent/agents/safety_agent.py` | `SafetyAgent.run; safety_precheck` |
| 17 | Report Generation Agent | `executable_not_tested` | `P0_truthfulness_fix` | `synglue_agent/agents/report_agent.py; synglue_agent/tools/report_generator.py` | `ReportAgent.run; generate_markdown_report; generate_candidate_table` |
