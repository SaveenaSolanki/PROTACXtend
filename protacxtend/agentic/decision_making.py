...
from protacxtend.schemas.agentic_schema import DesignGoal, PerceptionState, ReasoningState
...
class DecisionMakingAgent:
    ...
    def choose_next_action(
        ...
        return NextAction(
            ...
            selected_tool="protacxtend.backend.main.run_workflow_from_request",
