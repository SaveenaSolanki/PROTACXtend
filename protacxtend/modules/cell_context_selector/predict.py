...
from protacxtend.modules.cell_context_selector.features import MolCache
from protacxtend.modules.cell_context_selector.schemas import MODEL_VERSION
...
def _load(path):
    ...
    if not p.exists():
        raise CellContextModelError(
            ...
            "python -m protacxtend.modules.cell_context_selector.examples."
...
def predict_cell_context(protac: str, poi: str | None = None, e3: str | None = None,
    ...
    from protacxtend.modules.cell_context_selector import omics, prepare
