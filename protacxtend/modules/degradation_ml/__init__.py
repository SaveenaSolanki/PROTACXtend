...
Public API:
    ...
    from protacxtend.modules.degradation_ml import predict_degradation
...
from protacxtend.modules.degradation_ml.dataset import (
    dataset_report,
    load_curated,
)
from protacxtend.modules.degradation_ml.features import (
    DEFAULT_MODEL_PATH,
    EntityEncoder,
    feature_matrix,
    featurize_molecule,
...
from protacxtend.modules.degradation_ml.models import (
    evaluate_splits,
    ood_distance,
    train_pdc50,
)
from protacxtend.modules.degradation_ml.predict import (
    DegradationModelError,
    predict_degradation,
)
from protacxtend.modules.degradation_ml.schemas import (
    MODEL_VERSION,
    PredictionResult,
)
