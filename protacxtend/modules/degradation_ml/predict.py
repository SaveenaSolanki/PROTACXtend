...
from protacxtend.modules.degradation_ml.models import ood_distance
from protacxtend.modules.degradation_ml.schemas import PredictionResult
...
def predict_degradation(smiles: str, target: str | None = None, e3: str | None = None,
    ...
    if not path.exists():
        raise DegradationModelError(
            ...
            "python -m protacxtend.modules.degradation_ml.examples.train_demo "
