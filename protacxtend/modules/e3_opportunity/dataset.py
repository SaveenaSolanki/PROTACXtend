...
Recruiters: DOI-cited E3-ligand library (protacxtend/data/
...
from protacxtend.modules.cell_context_selector import dataset as m5ds
from protacxtend.modules.cell_context_selector import omics
from protacxtend.modules.cell_context_selector.genemap import target_to_gene
from protacxtend.modules.e3_opportunity.e3_catalog import alias_to_genes

logger = logging.getLogger("protacxtend.e3_dataset")

MODULE_DIR = Path(__file__).resolve().parent
DATA_DIR = MODULE_DIR / "data"
LIGAND_LIBRARY = (Path(__file__).resolve().parents[3] / "protacxtend"
