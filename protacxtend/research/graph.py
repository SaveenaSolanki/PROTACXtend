...
from protacxtend.research.reasoning import plan_query, synthesize
...
from protacxtend.research.schemas import EvidenceItem, SearchPlan, StepLog
from protacxtend.research.sources import (
    GRAPH_SOURCES,
    SCIENTIFIC_FIRST,
    WEB_SOURCES,
    make_clients,
...
async def _node_enrich(state: ResearchState, cfg: ResearchConfig,
        ...
        if crossref and item.doi:
            try:
                ...
                if rec:
                    ...
                    from protacxtend.research.retrieval import normalize_title
    ...
    if crossref:
        for item in validate_items:
            ...
            cr_title = str(rec["title"] or "")
            extra["crossref_title"] = cr_title[:250]
            from protacxtend.research.retrieval import normalize_title as _nt
...
def _node_finalize(state: ResearchState, cfg: ResearchConfig,
    ...
    steps = _log_step(state, "finalize",
                      ...
                      t0=t0)
    from protacxtend.research.schemas import ResearchReport, SourceSearched
