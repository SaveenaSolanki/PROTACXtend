...
from protacxtend.research.reasoning import deterministic_synthesis, plan_deterministic
from protacxtend.research.retrieval import (
    canonical_url,
    dedup_and_merge,
    dedup_id,
...
from protacxtend.research.schemas import EvidenceItem
from protacxtend.research.sources import is_biomedical_query
...
class TestScoring:
    def test_recency_and_authority_monotonic(self):
        ...
        import protacxtend.research.retrieval as rt
...
class TestGraphRun:
    def test_full_graph_offline(self):
        from protacxtend.research.graph import run_research_graph
        cfg = _test_config()
...
class TestCache:
    def test_disk_cache_roundtrip(self, tmp_path):
        from protacxtend.research.httpbase import AsyncApiClient
...
class TestLiveApis:
    def test_europepmc_live_search(self):
        async def _run():
            ...
            from protacxtend.research.sources import EuropePMCClient
            cfg = ResearchConfig()
