...
from protacxtend.llm.schemas import EvidenceDecision, Route, RepairDecision, RepairAction
from protacxtend.llm.tool_registry import (
    validate_selected_tools, requires_human_approval, ALLOWED_TOOLS,
)
from protacxtend.llm.context import summarize_evidence, compact_state_for_llm
from protacxtend.llm.decision_layer import (
    fallback_evidence_decision, llm_evidence_gate, route_after_llm_evidence_gate,
)
from protacxtend.llm.ollama_client import structured_chat, structured_chat_with_fallback
...
class TestEvidenceGateNode:
    def test_design_route_maps_to_planner(self, monkeypatch):
        ...
        from protacxtend.llm import gateway
        monkeypatch.setattr(
            gateway,
            "structured_chat",
