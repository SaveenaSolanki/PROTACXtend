...
from protacxtend.tools.retrosynthesis import (
...
class TestKnownProtacs:
    ...
    def test_real_routes_on_known_protacs(self):
        ...
        from protacxtend.tools.retrosynthesis import _aizynth_config_available
        from protacxtend.tools.retrosynthesis_engines import aizynth_package_available
