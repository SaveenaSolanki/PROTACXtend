...
from protacxtend.tools.ternary_ensemble import (
...
class TestEscalationPolicy:
    ...
    def test_low_geometric_rejects_no_expensive(self, monkeypatch):
        monkeypatch.setattr(
            "protacxtend.tools.ternary_ensemble.geometric_proxy_score",
...
class TestEnsembleExecution:
    ...
    def test_ensemble_no_crash_all_methods_fail(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "protacxtend.tools.ternary_ensemble.p4ward_score",
            lambda c, **kw: {"score": None, "ok": False, "tool": "p4ward", "error": "no_run_dir"},
        )
        monkeypatch.setattr(
            "protacxtend.tools.ternary_ensemble.se3_protacs_score",
    ...
    def test_ensemble_consensus_with_two_methods(self, monkeypatch):
        ...
        monkeypatch.setattr("protacxtend.tools.ternary_ensemble.geometric_proxy_score", fake_geom)
        monkeypatch.setattr("protacxtend.tools.ternary_ensemble.se3_protacs_score", fake_se3)
        cand = {"candidate_id": "c1"}
...
class TestSe3Availability:
    def test_se3_unavailable_graceful(self):
        ...
        from protacxtend.tools.ternary_ensemble import se3_protacs_score
