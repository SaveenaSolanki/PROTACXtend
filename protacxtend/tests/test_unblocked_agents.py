...
from protacxtend.agents.binder_agent import TargetBinderRetrievalAgent  # noqa: E402
...
class TestAdmetAi:
    def test_runner_script_exists(self):
        from protacxtend.tools.admet_integration import ADMET_AI_READY, ADMET_AI_RUNNER
    ...
    def test_rules_fallback_without_venv(self, monkeypatch):
        from protacxtend.tools import admet_integration as ai
...
class TestFragmentLinkers:
    ...
    def test_scanner_library_contains_fragments(self):
        from protacxtend.tools.linker_scanner import load_linker_library
