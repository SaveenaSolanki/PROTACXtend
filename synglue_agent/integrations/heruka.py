...
CLI (Feynman-style):
    python -m synglue_agent.integrations.heruka export --run <run_id> --out bundle.json
    python -m synglue_agent.integrations.heruka push --run <run_id>
    python -m synglue_agent.integrations.heruka status
"""
