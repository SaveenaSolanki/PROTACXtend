...
MEMORY_DIR = ROOT / "synglue_agent" / "memory"
...
class LearningStore:
    ...
    def __init__(self, memory=None):
        from synglue_agent.tools.learning_memory import LearningMemory
    ...
    def record_repair_outcome(self, *, problem_type: str, approach: str,
        ...
        from synglue_agent.tools.learning_memory import LearningSource, Outcome
    ...
    def retrieve_repair_for_failure(self, *, problem_type: str, failure_reason: str,
        ...
        from synglue_agent.agents.learning_integration import advise_repair
