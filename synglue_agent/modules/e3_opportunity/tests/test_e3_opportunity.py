...
from synglue_agent.modules.e3_opportunity import context, e3_catalog, recruiters
from synglue_agent.modules.e3_opportunity import dataset as ds
from synglue_agent.modules.e3_opportunity import rank as rank_mod
...
class TestEvidenceRules:
    ...
    def test_structure_unknown_when_unsupported(self):
        ...
        from synglue_agent.modules.e3_opportunity.structure import structural_axis
    ...
    def test_lysine_unknown_without_structure(self):
        from synglue_agent.modules.e3_opportunity import lysines
