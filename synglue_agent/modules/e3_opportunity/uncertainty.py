...
from synglue_agent.modules.e3_opportunity import context, localization
from synglue_agent.modules.e3_opportunity.e3_catalog import CATALOG
from synglue_agent.modules.e3_opportunity.structure import e3_structural_evidence
...
def compose(poi_gene: str | None, e3_gene: str, cell_line: str | None,
    ...
    # molecular OOD
    if warhead:
        from synglue_agent.modules.e3_opportunity.recruiters import recruiters
        rec = recruiters()
