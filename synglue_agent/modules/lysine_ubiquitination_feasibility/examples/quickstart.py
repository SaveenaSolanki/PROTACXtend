...
Usage: python -m synglue_agent.modules.lysine_ubiquitination_feasibility.examples.quickstart
"""
...
from synglue_agent.tools.lysine_ubiquitination_tool import run_lysine_ubiquitination
