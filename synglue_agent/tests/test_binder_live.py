...
from synglue_agent.agents.binder_agent import TargetBinderRetrievalAgent, _cached_request  # noqa: E402
...
class TestNormalization:
    def test_micromolar_units_converted(self, monkeypatch):
        ...
        monkeypatch.setattr("synglue_agent.agents.binder_agent._cached_request", lambda *a_, **k: payload)
