...
class TestP4wardWrapper:
    ...
    def test_import(self):
        ...
        from synglue_agent.tools.p4ward_wrapper import (
            P4wardWrapper,
            P4wardRunResult,
    ...
    def test_failure_diagnosis(self, p4ward_wrapper, benchmark_data, tmp_path):
        ...
        from synglue_agent.tools.p4ward_wrapper import _diagnose_failure

        # Create mock results
        from synglue_agent.tools.p4ward_wrapper import P4wardRunResult
...
class TestRunTernaryScreening:
    ...
    def test_function_import(self):
        ...
        from synglue_agent.tools.p4ward_wrapper import run_ternary_screening
