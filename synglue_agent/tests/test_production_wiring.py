...
class TestCheckpointer:
    def test_get_checkpointer_fallback_never_crashes(self, tmp_path, monkeypatch):
        ...
        from synglue_agent.agents.checkpointer import get_checkpointer
        cp = get_checkpointer()
    ...
    def test_run_id_thread_namespaced(self):
        from synglue_agent.agents.checkpointer import run_id_thread
...
class TestJobQueue:
    def _q(self, tmp_path):
        from synglue_agent.queue.job_queue import JobQueue
