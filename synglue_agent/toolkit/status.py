...
from synglue_agent.toolkit.registry import load_toolkit_registry
from synglue_agent.toolkit.schema import normalize_text
...
REAL_IMPLEMENTATIONS = {
    "rdkit": [
        ("synglue_agent.tools.rdkit_chemistry", "validate_smiles"),
        ("synglue_agent.tools.rdkit_chemistry", "calculate_descriptors"),
        ("synglue_agent.tools.rdkit_chemistry", "calculate_morgan_fingerprint"),
    ],
    "pubchem": [
        ("synglue_agent.tools.pubchem_lookup", "search_compound_by_name"),
        ("synglue_agent.tools.pubchem_lookup", "get_compound_by_cid"),
    ],
    "uniprot": [
        ("synglue_agent.tools.uniprot_lookup", "search_uniprot"),
        ("synglue_agent.tools.uniprot_lookup", "get_uniprot_record"),
    ],
    "rcsb pdb": [
        ("synglue_agent.tools.rcsb_pdb_lookup", "search_pdb_by_uniprot"),
        ("synglue_agent.tools.rcsb_pdb_lookup", "get_pdb_entry"),
    ],
    "chembl": [
        ("synglue_agent.tools.chembl_lookup", "search_targets"),
        ("synglue_agent.tools.chembl_lookup", "get_target_activities"),
    ],
    "bindingdb": [
        ("synglue_agent.tools.bindingdb_lookup", "search_bindingdb_local"),
        ("synglue_agent.tools.bindingdb_lookup", "load_bindingdb_local_tsv"),
    ],
    "adme/tox skill": [("synglue_agent.tools.admet_predictors", "predict_admet")],
    "drugbank": [("synglue_agent.tools.drugbank_client", "search_drugbank_compounds")],
    "lean magnetdb inference": [("synglue_agent.tools.magnetdb_lookup", "run_lean_magnetdb_inference")],
}


STUB_IMPLEMENTATIONS = {
    "target assessment": [("synglue_agent.tools.target_resolver", "resolve_target")],
    "warhead mining": [("synglue_agent.tools.chembl_client", "retrieve_known_binders")],
    "e3 ligase selection": [("synglue_agent.tools.e3_selector", "select_e3_ligands")],
    "linker design": [("synglue_agent.tools.linker_generator", "generate_linkers_for_pair")],
    "assembly agent": [("synglue_agent.agents.construction_agent", "MolecularConstructionAgent")],
    "dc50/dmax prediction": [("synglue_agent.tools.degradation_predictor", "predict_dc50_dmax")],
    "adme/tox skill": [("synglue_agent.tools.admet_predictor", "predict_admet")],
    "synthesis planning": [("synglue_agent.tools.retrosynthesis_filter", "retrosynthesis_feasibility_filter")],
    "novelty/ip check": [("synglue_agent.tools.novelty_checker", "check_novelty")],
    "ternary complex modeling": [("synglue_agent.tools.ternary_feasibility", "assess_ternary_feasibility")],
    "ranking skill": [("synglue_agent.tools.ranker", "pairwise_tournament_ranking")],
    "report generation": [("synglue_agent.tools.report_generator", "generate_candidate_table")],
    "supervisor": [("synglue_agent.agents.supervisor_agent", "SupervisorAgent")],
    "target agent": [("synglue_agent.agents.target_agent", "TargetResolverAgent")],
    "warhead agent": [("synglue_agent.agents.warhead_agent", "WarheadSelectionAgent")],
    "e3 agent": [("synglue_agent.agents.e3_agent", "E3LigandSelectionAgent")],
    "linker agent": [("synglue_agent.agents.linker_agent", "LinkerGenerationAgent")],
    "docking/ternary agent": [("synglue_agent.agents.ternary_agent", "TernaryFeasibilityAgent")],
    "adme/tox agent": [("synglue_agent.agents.admet_agent", "ADMETAgent")],
    "novelty/ip agent": [("synglue_agent.agents.novelty_agent", "NoveltyAgent")],
    "ranking agent": [("synglue_agent.agents.ranking_agent", "RankingAgent")],
    "report agent": [("synglue_agent.agents.report_agent", "ReportAgent")],
}
...
def _rdkit_smoke_test() -> dict[str, Any]:
    try:
        from synglue_agent.tools.rdkit_chemistry import calculate_descriptors, validate_smiles
...
def classify_existing_implementation(tool_name: str) -> dict[str, Any]:
    ...
    if real_found:
        ...
        if normalized == "bindingdb":
            try:
                from synglue_agent.tools.bindingdb_lookup import find_bindingdb_local_tsv
