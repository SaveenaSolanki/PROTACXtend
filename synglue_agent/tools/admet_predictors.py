...
from synglue_agent.tools.rdkit_chemistry import calculate_descriptors


DEFAULT_LOCAL_MODEL_PATHS = [
    Path("synglue_agent/models/admet_model.pkl"),
    Path("synglue_agent/models/admet_model.joblib"),
]
