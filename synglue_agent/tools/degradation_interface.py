...
def _synglue_backend(smiles_list: List[str]) -> Optional[List[Dict[str, Any]]]:
    try:
        from synglue_agent.tools.synglue_degradation import predict_degradation_batch
...
def _heuristic_backend(smiles_list: List[str]) -> List[Dict[str, Any]]:
    from synglue_agent.tools.synglue_degradation import _heuristic_single
    results = []
...
def degradation_backend_status() -> Dict[str, Any]:
    ...
    import os
    from synglue_agent.tools.chemprop_degradation import chemprop_available
    from synglue_agent.tools.synglue_degradation import check_models_available as _sg
