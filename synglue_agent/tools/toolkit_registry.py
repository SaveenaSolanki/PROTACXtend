...
from synglue_agent.tools.toolkit_categories import CATEGORIES
...
TOOLKIT_REGISTRY: list[dict[str, Any]] = [
    ...
    _tool(
        ...
        notes="Working adapter: synglue_agent.tools.retrosynthesis_engines.run_aizynth_engine. "
    ...
    _tool(
        ...
        notes="Working adapter: synglue_agent.tools.retrosynthesis_engines.AskcosClient "
    ...
    _tool(
        ...
        notes="Working adapter: synglue_agent.tools.retrosynthesis_engines.run_openmt_engine; "
