...
from synglue_agent.tools.protac_repo_tool_wrappers import get_protac_repo_wrapper_status
from synglue_agent.tools.repo_tool_adapter import route_repo_tool_request
from synglue_agent.tools.tool_status import detect_all_tool_statuses
    ...
    repo_wrapper_capabilities = [
        {
            ...
            "callable_dispatch": "synglue_agent.tools.protac_repo_tool_wrappers.execute_protac_repo_tool",
        }
