...
| 2 | "23-node core scientific workflow + 8 controlled-search/feedback extensions = 31 documented agent nodes" | `agents/graph.py` `LocalSynGlueWorkflowGraph.nodes` (31 registered) | yes — all 31 registered | import-tested (23-core accounting in AGENT_WORKFRAME.md; RankingAgent runs twice) | ✅ SAFE with the 23+8 wording (production graph stops only at terminal gates) |
